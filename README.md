...
|--------------|----------------------------|
| **1. Data Import** | Load CSV dataset (`ev_stations.csv`) using *pandas*. <br> Cargar el dataset CSV con *pandas*. |
| **2. Data Cleaning** | Handle null values, type conversion, and normalization. <br> Limpieza de nulos, tipos y normalización. |
| **3. Exploration (EDA)** | Explore countries, operators, and connectors. <br> Exploración de países, operadores y conectores. |
| **4. Visualization** | Use *matplotlib*, *seaborn*, and *folium* for charts and maps. <br> Visualización con *matplotlib*, *seaborn* y *folium*. |
| **5. Insights & Reporting** | Identify trends, growth zones, and standards. <br> Identificar tendencias, zonas de expansión y estándares. |
